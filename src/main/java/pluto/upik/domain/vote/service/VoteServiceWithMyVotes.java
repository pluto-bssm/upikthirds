...
public class VoteServiceWithMyVotes {
     ...
     *
     * @param input 생성할 투표의 제목, 카테고리, 옵션 목록이 포함된 입력 값
     ...
     *
     * 더미 사용자 ID를 사용하여 각 투표에 대해 사용자의 참여 여부와 옵션별 통계 정보를 포함한 결과를 제공합니다.
     *
     * @return 투표 정보와 통계가 포함된 VotePayload 리스트
     */
    ...
    /**
     * 지정된 사용자의 관점에서 모든 투표 목록과 각 투표의 옵션별 통계, 총 응답 수, 사용자의 참여 여부를 반환합니다.
     *
     * @param userId 투표 참여 여부를 확인할 사용자 ID
     * @return 각 투표에 대한 옵션별 통계, 총 응답 수, 사용자의 투표 참여 여부가 포함된 VotePayload 리스트
     */
    @Transactional(readOnly = true)
    ...
    /**
     * 지정된 투표 ID에 해당하는 투표 상세 정보를 조회합니다.
     *
     * 더미 사용자 ID를 사용하여 투표 참여 여부 및 통계를 포함한 상세 정보를 반환합니다.
     *
     * @param voteId 조회할 투표의 UUID
     * @return 투표 상세 정보 페이로드
     */
    @Transactional(readOnly = true)
     ...
     *
     * 투표 정보, 옵션별 응답 수 및 비율, 총 응답 수, 생성자 이름, 사용자의 투표 참여 여부를 포함한 상세 정보를 반환합니다.
     *
     ...
     *
     * 각 투표에 대해 전체 응답 수, 옵션별 응답 수 및 비율, 투표 참여 여부(항상 미참여로 표시)를 포함한 정보를 제공합니다.
     *
     * @return 응답 수 기준 상위 3개의 OPEN 투표에 대한 상세 정보 리스트
     */
    @Transactional(readOnly = true)
     ...
     *
     * 각 투표에 대해 옵션별 응답 수, 전체 응답 수, 응답 비율, 그리고 사용자의 투표 참여 여부를 포함한 정보를 제공합니다.
     *
     * @param userId 투표를 생성한 사용자 ID
     * @return 사용자가 생성한 투표의 상세 정보 목록
     */
    @Transactional(readOnly = true)
